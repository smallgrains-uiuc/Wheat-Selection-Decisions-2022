...
all<- rbind(a, b, c, d, a2, b2, b3, c2, d2,  e, YT22)
...
write.csv(all2, 'ILTrainingSetPhenotypesJuly.18.2022.csv')

#remove an outlier 
all2<- read.csv('ILTrainingSetPhenotypesJuly.18.2022.csv', row.names=1)
